...
<body class="gray-bg">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="project-people">
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="${base}/static/img/a3.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="${base}/static/img/a1.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="${base}/static/img/a2.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="${base}/static/img/a4.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="${base}/static/img/a5.jpg"></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="project-people">
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="${base}/static/img/a7.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="${base}/static/img/a6.jpg"></a>
                                                    <a href="projects.html"><img alt="image" class="img-circle" src="${base}/static/img/a3.jpg"></a>
                                                </td>
                                                <td class="project-actions">
                                                    <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
    ...
    <!-- 自定义js -->
    <script src="${base}/static/js/content.js"></script>
    <!--flotdemo-->
